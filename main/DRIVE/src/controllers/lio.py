...
from main.DRIVE.src.controllers.actor_critic import preprocessing_module, ActorCritic
from main.DRIVE.src.utils import assertEquals, get_param_or_default
...
class LIO(ActorCritic):
    ...
    def preprocess(self):
        ...
        for i, memory, incentive_net in zip(range(self.nr_agents), self.memories, self.incentive_nets):
